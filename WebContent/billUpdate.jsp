...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
             <form class="Bill_Update" action="Bill_Update">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div class="">
                    <label for="Bill_number">订单编码：</label>
                    <input type="text" name="Bill_number" id="Bill_number"value=<%=request.getParameter("Bill_number")%> />
                    <span>*</span>
                </div>
                <div>
                ...
                <div>
                    <label for="Bill_Pqunatity">商品数量：</label>
                ...
                <div>
                    ...
                    <input type="text" name="Bill_Pprovider" id="Bill_Pprovider" />
                    <span>*</span>
                </div>
                <div>
                	<label for="Bill_State">是否付款：</label>
